...
public class brainTeaser extends AppCompatActivity implements View.OnClickListener{
    ...
    int score=0;
    int totalQueLength = mainQuestions.questions.length;
    int totaltapLength = mainQuestions.images.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalQuestionsView = findViewById(R.id.txt_total_brainTeaser);
        questionView = findViewById(R.id.textquestion);
        seeImage = findViewById(R.id.image_view);
    ...
    public void onClick(View view) {
        ...
        if(clickedButton.getId()==R.id.btnNxt){
            if(selectedAnswer.equals(mainQuestions.answers[currentQuestionsIndex])){
                score++;
            }
    ...
    void loadNewQuestion(){
        ...
        questionView.setText(mainQuestions.questions[currentQuestionsIndex]);
        seeImage.setImageResource(mainQuestions.images[currentQuestionsIndex]);
        btnAns1.setText(mainQuestions.choice[currentQuestionsIndex][0]);
        btnAns2.setText(mainQuestions.choice[currentQuestionsIndex][1]);
        btnAns3.setText(mainQuestions.choice[currentQuestionsIndex][2]);
        btnAns4.setText(mainQuestions.choice[currentQuestionsIndex][3]);
    ...
    private void Home() { startActivity(new Intent( brainTeaser.this, mainMenu.class));
        finish();
    }
    void restartQuiz(){
        score = 0;
